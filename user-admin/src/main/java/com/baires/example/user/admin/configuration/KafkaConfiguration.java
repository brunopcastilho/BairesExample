package com.baires.example.user.admin.configuration;

import com.baires.example.user.admin.domain.User;
import com.baires.example.user.admin.domain.UserSerdes;
import com.baires.example.user.admin.domain.UserSerializer;
